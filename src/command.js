...
// COMMAND Base Class
function Command(keyword, options, configs=null) {
...
Command.create = function(definition, prefix='/') {
  ...
  var configs = definition.length >=4 ? definition[3] : null;
  switch (definition[0]){
    case 'string':
    ...
    case 'calendar':
      return new CalendarCommand(prefix + definition[1], definition[2], configs);
    default:
      return null;
  }
}
...
DatetimeCommand.prototype.getHints = function (token) {
  ...
  if (this.configs_ !==null){
    var i18n = {};
    i18n["dayNames"] = this.configs_["dayNames"] || I18N_["dayNames"];
    i18n["monthNames"] = this.configs_["monthNames"] || I18N_["monthNames"];
